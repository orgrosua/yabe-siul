...
class Router
{
    ...
    {
        // Get cached APIs
        $transient_name = 'siul_scanned_apis_' . SIUL::VERSION;
         ...
         */
        do_action('a!yabe/siul/api/router:before_scan', $finder);
    ...
    public function register_apis(): void
    {
        ...
        $apis = apply_filters('f!yabe/siul/api/router:register_apis', $this->apis);
