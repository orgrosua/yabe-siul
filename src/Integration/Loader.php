...
class Loader
{
    ...
    public function scan_integrations()
    {
        ...
        $transient_name = 'siul_scanned_integrations_' . SIUL::VERSION;
         ...
         */
        do_action('a!yabe/siul/integration/loader:scan_integrations.before_scan', $finder);
    ...
    public function register_integrations(): void
    {
        ...
        $integrations = apply_filters('f!yabe/siul/integration/loader:register_integrations', $this->integrations);
