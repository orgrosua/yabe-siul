...
class Requirement
{
     ...
     *
     * @param list<string|array{0: string, 1: string}> $plugins The plugins to check. Use the plugin file path, e.g. `yabe-siul/yabe-siul.php`.
     */
    ...
    {
        $name = esc_html(get_plugin_data(SIUL::FILE, false)['Name']);
        ...
        $notice = sprintf(
            ...
            esc_html__('The %1$s plugin minimum requirements are not met:', 'yabe-siul'),
            '<strong>' . $name . '</strong>'
        );
