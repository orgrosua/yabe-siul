...
= 2.0.100 (final version) =
* **Fix [Migration]**: Use the `tailwind.config.js` content instead of the `preset.js` content.
...
= 1.0.14 =
* **New**: [LiveCanvas](https://livecanvas.com/) integration
* **Improve**: Integrations panel allows to enable/disable integrations
